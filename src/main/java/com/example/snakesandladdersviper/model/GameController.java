...
public class GameController {
    ...
    public GameController(List<Player> players, Player currentPlayer, Board board, List<Question> questions, List<GameHistory> history, String difficultyLevel, Player winner) {
